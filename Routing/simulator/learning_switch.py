...
class LearningSwitch (api.Entity):
	...
	def handle_port_down (self, port):
		...
		"""
		for dst in dict(self.f_table):
			if self.f_table[dst] == port:
				del self.f_table[dst]
